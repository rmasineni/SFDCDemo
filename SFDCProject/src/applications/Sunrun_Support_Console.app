...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <label>Sunrun Support Console</label>
    <listPlacement>
    ...
    <tab>Contract_Array__c</tab>
    <tab>Proposal__c</tab>
    <tab>Reassignment__c</tab>
    <tab>Contract_Performance_Guarantee__c</tab>
    <tab>Asset__c</tab>
    <tab>SalesComp</tab>
    <tab>Custom_Search</tab>
    <tab>FS_Dispatch__c</tab>
    ...
    <workspaceMappings>
        ...
        <mapping>
            <fieldName>Service_Contract__c</fieldName>
            <tab>Contract_Array__c</tab>
        </mapping>
        <mapping>
            <fieldName>Service_Contract__c</fieldName>
