trigger ProjectcStats on Project__c(after insert, after update, after delete, after undelete) {
   /* try {
      ...
      hoopla.NotifierGlobal.processNotifications('Project__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
